...
def addregister():
    if request.vars['FirstName']:
        ...
        db.executesql("INSERT INTO students (first_name,email,password,reset_password_key) VALUES (%s,%s,%s,%s)", placeholders=(first_name,email,password,reset_password_key))
    else:
